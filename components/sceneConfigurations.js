    ...
    },
    {
        ...
        dialogues: [
            ...
            },
            {
                ...
                dialogue: ["Отвлеку тебя немного интересным фактом! Ты знаешь сказку 'Муха-Цокотуха'? Мало кто знает, что такое цокатуха? Слово 'цокотуха' просто-напросто означает 'болтушка'."],
                btns: ["Далее..."],
            },
            {
                char: {
